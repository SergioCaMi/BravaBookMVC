...
import { validateApartment, validateReservation, validateUserUpdate, validateMongoId, handleValidationErrors } from "../middlewares/validation.js"; //
...
router.post(
  "/apartment/edit/:id/save",
  validateMongoId("id"),
  requireAuth,
  requireAdmin,
  uploadApartmentImages.fields([{ name: "apartmentPhotos" }]),
  validateApartment,
  handleValidationErrors,
  adminController.putApartmentEdit
);
...
// Borrar/Activar un apartamento (alternar estado activo)
