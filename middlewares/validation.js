...
export const validateApartment = [
  ...
  body('rules.*')
    ...
    .withMessage('Cada regla debe tener entre 1 y 200 caracteres'),
  ...
  body('bedsPerRoom')
    .optional()
    .isArray()
    .withMessage('Las camas por habitación deben ser un array'),

  body('bedsPerRoom.*')
    .optional()
    .isInt({ min: 1, max: 10 })
    .withMessage('El número de camas por habitación debe estar entre 1 y 10'),

  body('bathrooms')
    .optional()
    .isInt({ min: 1, max: 10 })
    .withMessage('El número de baños debe estar entre 1 y 10'),
...
export const validateReservation = [
  ...
  body('status')
    ...
    .withMessage('El estado debe ser "confirmed" o "cancelled"'),

  body('paid')
    .optional()
    .isBoolean()
    .withMessage('El estado de pago debe ser verdadero o falso'),
  ...
  body('totalPrice')
    ...
    .isFloat({ min: 0 })
    .withMessage('El precio total debe ser positivo')
];
...
export const validateApartmentFilters = [
  ...
  body('guests')
    .optional()
    .isInt({ min: 1, max: 50 })
    .withMessage('El número de huéspedes debe estar entre 1 y 50'),
